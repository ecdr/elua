...
// Lua: tm4c.pio.set_function( func1, func2, ..., funcn )
...
// Lua: tm4c.pio.set_strength( drive, pin1, pin2, ..., pinn )
...
// Lua: tm4c.pio.set_direction( dir, pin1, pin2, ..., pinn )
...
const LUA_REG_TYPE lm3s_pio_map[] =
{
  ...
  { LSTRKEY( "MA_6" ), LNUMVAL( GPIO_STRENGTH_6MA ) },
  { LSTRKEY( "MA_10" ), LNUMVAL( GPIO_STRENGTH_10MA ) },
  { LSTRKEY( "MA_12" ), LNUMVAL( GPIO_STRENGTH_12MA ) },
