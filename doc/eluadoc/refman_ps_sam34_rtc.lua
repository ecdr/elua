...
data_en = 
{
  ...
  -- Title
  title = "eLua reference manual - SAM34 Real Time Clock module",

  -- Menu name
  menu_name = "rtc",

  -- Overview
  overview = [[This module contains functions to drive the Real-Time Clock.</p>
